...
from train import prepare_treelstm_minibatch
...
class TreeLSTMClassifier_Glove(TreeLSTMClassifier):
    pass


class TreeLSTMClassifier_W2V(TreeLSTMClassifier):
    pass


def build_TreeLSTM_models():
    v_glove, vectors_glove = build_pt_embeddings('glove')
    v_w2v, vectors_w2v = build_pt_embeddings('w2v')
    i2t, t2i = build_sentiment_mappings()

    models_fns = [
        TreeLSTMClassifier_Glove,
        TreeLSTMClassifier_W2V
    ]
...
if __name__ == "__main__":
    ...
    seeds = ['42', '420', '4200']
    for seed in seeds:
        models_fns, models_args, nums_iterations = build_TreeLSTM_models()
        run_experiments(models_fns, models_args, train_data, dev_data, test_data, nums_iterations,
                        base_name='TreeLSTM', prep_fn=prepare_treelstm_minibatch, seed=seed)